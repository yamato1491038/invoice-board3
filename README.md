...
現在勤めている会社であったら便利だと思うものを作りました。
現在請求書まとめているのは紙媒体で郵送や会社への持ち込みが必要な状況。また現場社員の
入力間違いが漏れ、必要書類の不備が散見されている状況である。
また紙媒体をエクセルに入力と手間がかかっています。

コロナの影響でなるべく非接触が求められる中で作成しようと思いました。
もともと現場の人はタブレット所持しているためWEBアプリというものが都合がよかったです。

WEB化することにより入力漏れや文字が読めないなどの不備がなくなり、金額計算のミスもなくなります。
管理側の入力手間が省け、大幅な業務効率化になります。

## 工夫したポイント

### 一覧表示
現場の業務の単価や種類が今後変わっても一覧表示はそれに対応し、なくなった業務は登録できないように管理者側で調整できる機能つけました。
...
### メール機能
info@vr-invoice.comというようなよくお知らせでくるメールにしたかったのでgmailなどではなく
AWSのSESを使用。またRoute53でドメイン取得した。
