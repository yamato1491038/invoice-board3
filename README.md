...
<img width="1436" alt="インフラ2" src="https://user-images.githubusercontent.com/67918886/103659288-9275d900-4faf-11eb-94dd-900544be35ea.png">
...
- 管理者の一覧確認（コミュニケーターごと）
- 管理者の契約登録、変更、削除機能
- 管理者の帳票機能（一ヶ月の全コミュニケーターごとの総額一覧表示）
- 管理者のハンコ機能（デジタルハンコ）
